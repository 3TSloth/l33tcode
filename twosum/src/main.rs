impl Solution {
    pub fn two_sum(nums: Vec<i32>, target: i32) -> Vec<i32> {
        ...
        //We can reduce the number of pairs produced by removing the ones where the index is the same e.g. nums[0] with nums[0]
        //We can also reduce the number of pairs produced by removing the ones where they are duplicated, e.g. (0, 1) and (1, 0) are the same
